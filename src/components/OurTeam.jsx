...
const OurTeam = () => {
  ...
  return (
    <div className="h-screen w-full flex flex-col items-center justify-center bg-neutral-700">
      <div className="text-neutral-100  flex flex-col justify-center items-center max-w-xl">
